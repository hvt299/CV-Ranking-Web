            ...
            <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 w-full py-12 md:py-20 flex flex-col lg:flex-row gap-12">
                ...
                <div className="flex-1 bg-white dark:bg-slate-900/20 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-12 shadow-sm space-y-16 text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
                    ...
                    <section id="services" className="scroll-mt-32">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/50 space-y-4 font-sans">
                    ...
                    <section id="liability" className="scroll-mt-32">
                        ...
                        <div className="prose prose-slate font-sans dark:prose-invert max-w-none prose-p:leading-loose mb-4">
                        ...
                        <div className="p-5 border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-500/10 text-slate-700 dark:text-slate-300 rounded-r-xl leading-relaxed font-sans">
