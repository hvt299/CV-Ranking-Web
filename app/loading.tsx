...
export default function GlobalLoading() {
    return (
        <div className="fixed inset-0 z-9999 flex flex-col items-center justify-center bg-slate-50/80 dark:bg-[#050505]/80 backdrop-blur-md transition-colors">
            <div className="relative flex flex-col items-center">
                {/* Vòng sáng tỏa ra phía sau (Glow Effect) */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-blue-500/20 blur-xl rounded-full animate-pulse pointer-events-none" />
