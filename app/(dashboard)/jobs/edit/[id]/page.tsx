...
export default function EditEnterpriseJobPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // KHOÁ CHẶT: Ngăn chặn tuyệt đối việc form lưu sớm khi chưa tới Bước 3
        if (currentStep < 3) {
            handleNextStep();
            return;
        }
    ...
    if (isFetching) return <div className="flex justify-center py-20"><div className="animate-spin h-10 w-10 border-b-2 border-blue-600 rounded-full"></div></div>;
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-200 dark:border-slate-700 min-h-125">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="space-y-3">
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                                        ...
                                        {locCountry === 'Việt Nam' ? (
                                            <>
                                                {/* Dropdown Tỉnh/Thành, Quận/Huyện, Xã/Phường: Tạm thời mock dữ liệu tĩnh */}
                ...
                {currentStep === 2 && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-700 pb-4 text-slate-800 dark:text-white"><FileText className="text-indigo-500" /> Nội dung JD (Dùng cho AI)</h2>
                            <div className="space-y-6">
                                <div>
                        ...
                        <div className="bg-indigo-50/50 dark:bg-indigo-900/10 p-6 rounded-3xl border border-indigo-100 dark:border-indigo-800">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 text-center">
                                    <p className="text-xs font-bold text-slate-500 uppercase mb-2">Kỹ năng cứng</p>
                                ...
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 text-center">
                                    <p className="text-xs font-bold text-slate-500 uppercase mb-2">Ngữ nghĩa NLP</p>
