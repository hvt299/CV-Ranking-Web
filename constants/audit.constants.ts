...
export const AUDIT_ACTION_CONFIG: Record<string, { label: string; colorClass: string }> = {
    ...
    [AuditAction.APPLICATION_STATUS_CHANGED]: { label: 'Cập nhật Ứng viên', colorClass: 'text-indigo-600 bg-indigo-50 dark:bg-indigo-500/10' },
    ...
    [AuditAction.HR_MEMBER_INVITED]: { label: 'Mời HR Member', colorClass: 'text-indigo-600 bg-indigo-50 dark:bg-indigo-500/10' },
