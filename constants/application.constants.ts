...
export const APPLICATION_STATUS_CONFIG: Record<string, any> = {
    [ApplicationStatus.NEW]: {
        ...
        label: 'Mới nộp',
        color: 'bg-info-100 text-info-700 dark:bg-info-500/10 dark:text-info-400',
        borderColor: 'border-info-500',
        headerBg: 'bg-info-100 text-info-700 dark:bg-info-500/10 dark:text-info-400',
        icon: FileText,
    },
    ...
    [ApplicationStatus.REVIEWING]: {
        ...
        headerBg: 'bg-warning-100 text-warning-700 dark:bg-warning-500/10 dark:text-warning-400',
        icon: Clock,
    },
    ...
    [ApplicationStatus.INTERVIEW]: {
        ...
        headerBg: 'bg-primary-100 text-primary-700 dark:bg-primary-500/10 dark:text-primary-400',
        icon: Users,
    },
    ...
    [ApplicationStatus.OFFERED]: {
        ...
        label: 'Đề nghị (Offer)',
        color: 'bg-hot-100 text-hot-700 dark:bg-hot-500/10 dark:text-hot-400',
        borderColor: 'border-hot-500',
        headerBg: 'bg-hot-100 text-hot-700 dark:bg-hot-500/10 dark:text-hot-400',
        icon: Award,
    },
    ...
    [ApplicationStatus.HIRED]: {
        ...
        headerBg: 'bg-success-100 text-success-700 dark:bg-success-500/10 dark:text-success-400',
        icon: CheckCircle2,
    },
    ...
    [ApplicationStatus.REJECTED]: {
        ...
        headerBg: 'bg-error-100 text-error-700 dark:bg-error-500/10 dark:text-error-400',
        icon: XCircle,
    },
    ...
    [ApplicationStatus.WITHDRAWN]: {
        ...
        headerBg: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400',
        icon: X,
    },
