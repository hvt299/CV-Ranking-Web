    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden flex flex-col h-full">
            ...
            <div className="p-6 md:p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
                ...
                <Link href="/my-applications" className="hidden sm:flex items-center gap-1 text-sm font-bold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors bg-primary-50 dark:bg-primary-900/20 px-4 py-2 rounded-xl">
            ...
            <div className="p-6 md:p-8 flex-1">
                {recentApps.length > 0 ? (
                            ...
                            return (
                                <div key={app.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 hover:border-primary-300 dark:hover:border-primary-700 hover:shadow-sm transition-all group">
                                    <div className="flex-1 min-w-0">
                                        <Link href={`/careers/${app.job_id}`} target="_blank" className="font-bold text-slate-800 dark:text-slate-200 text-base truncate block group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                                    ...
                                    <div className="flex items-center justify-between sm:justify-end gap-4 shrink-0 border-t border-slate-100 dark:border-slate-700 sm:border-0 pt-3 sm:pt-0">
                                        ...
                                        <Link href={`/careers/${app.job_id}`} target="_blank" className="sm:hidden p-2 bg-slate-50 dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300">
                    ...
                    <div className="h-full min-h-62.5 flex flex-col items-center justify-center text-center">
                        ...
                        <Link href="/careers" className="mt-5 px-6 py-2.5 bg-primary-600 text-white font-bold rounded-xl text-sm transition-colors hover:bg-primary-700 shadow-md shadow-primary-500/20">
                            Khám phá việc làm
                        </Link>
                    </div>
                )}
            ...
            {recentApps.length > 0 && (
                <div className="p-4 border-t border-slate-100 dark:border-slate-800 sm:hidden bg-slate-50 dark:bg-slate-900/50">
                    <Link href="/my-applications" className="flex items-center justify-center gap-1.5 text-sm font-bold text-primary-600 hover:text-primary-700 transition-colors w-full py-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                        Xem tất cả lịch sử
                    </Link>
                </div>
            )}
