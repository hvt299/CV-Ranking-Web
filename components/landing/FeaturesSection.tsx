...
export default function FeaturesSection() {
    return (
        <section
            id="features"
            className="
                py-32 px-6 relative scroll-mt-20
                bg-slate-50 dark:bg-[#070707]
                transition-colors
            "
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {FEATURES.map((feat, i) => (
                        <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="
                            p-8 md:p-10
                            rounded-3xl
