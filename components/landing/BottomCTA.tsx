...
export default function BottomCTA() {
    return (
        <section className="py-24 px-6 relative overflow-hidden bg-background dark:bg-slate-950">
            <div className="absolute inset-0 bg-linear-to-b from-blue-600/5 to-blue-600/5 dark:from-blue-600/10 dark:to-blue-600/10 pointer-events-none" />
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-12 md:p-20 rounded-[3rem] shadow-xl transition-colors duration-300">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                    <Link href={ROUTES.REGISTER} className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-full transition-colors w-full sm:w-auto shadow-lg shadow-blue-500/30">
                        Đăng ký miễn phí
                    </Link>
