...
export default function BottomCTA() {
    return (
        <section className="py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-slate-800 p-12 md:p-20 rounded-[3rem] shadow-xl transition-colors duration-300">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                    ...
                    <Link href="/contact" className="px-8 py-4 bg-transparent text-slate-800 dark:text-white font-black rounded-full border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-text transition-colors w-full sm:w-auto flex items-center justify-center gap-2">
